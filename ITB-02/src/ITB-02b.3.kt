...
fun main() {
    ...
    //Fem un condicional que mostri "SI" si el primer nombre es més petit que el segon, el segon més gran que el tercer...
    if (primerNombre < segonNombre && tercerNombre < segonNombre && quartNombre > tercerNombre && cinqueNombre < quartNombre) {
        print("SI")
    //I si no es compleix la primera condició, que mostri "SI" si el primer es més gran que el segon, el segon més petit que el tercer...
